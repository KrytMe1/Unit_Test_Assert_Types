...
def test_count_words_isinstance():
    ...
    assert isinstance(processor.count_words("text"), int)
...
def test_count_words_greater_less():
    ...
    processor = TextProcessor()
    result = processor.count_words("This is a test")
    result1 = processor.count_words("One two")
    result2 = processor.count_words("One two three four five six seven eight nine")
